...
var chapterclass = (function () {
     ...
     * @param next
     */
    chapterclass.prototype.getAll = function (req, res, next) {
        sql.findall("chapter", { status: 1 }).then(function (data) {
            if (data.length > 0) {
    ...
    chapterclass.prototype.getTree = function (req, res, next) {
        sql.findall("chapter", { status: 1 }).then(function (data) {
            if (data.length > 0) {
                var Arr = public_js_1.default.objdelete(['createId', 'createtime'], data);
                Arr.sort(public_js_1.default.compareUp('order'));
     ...
     * @param next
     */
    chapterclass.prototype.getOne = function (req, res, next) {
        sql.findOne("chapter", { AutoId: req.body.AutoId, status: 1 }).then(function (data) {
            if (data) {
     ...
     * @constructor
     */
    chapterclass.prototype.Delect = function (req, res, next) {
        sql.update("chapter", {
            status: 0,
     ...
     * @constructor
     */
    chapterclass.prototype.Save = function (req, res, next) {
